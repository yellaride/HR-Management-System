  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-6 border-b border-line-subtle">
      <div>
        ...
        <p className="mt-1 text-xs text-content-secondary font-medium">
      ...
      <div className="relative w-full md:w-72">
        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
          <Search className="h-4 w-4 text-content-muted transition-colors duration-200 group-hover:text-content-main" />
        </div>
        <input
          type="text"
